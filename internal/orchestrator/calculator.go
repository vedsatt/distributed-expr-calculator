...
// каждый раз, когда приходит результат таски от агента, хендлер отправляет ее в общий канал
// менеджер берет результат и ищет элемент мапы с каналами по айди результата
